...
```javascript
import nanmskmax from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanmskmax@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-nanmskmax/tags). For example,

```javascript
import nanmskmax from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanmskmax@v0.2.1-deno/mod.js';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-nanmskmax.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-nanmskmax

[test-image]: https://github.com/stdlib-js/stats-base-nanmskmax/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/stats-base-nanmskmax/actions/workflows/test.yml?query=branch:v0.2.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-nanmskmax/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-nanmskmax?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-nanmskmax.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-nanmskmax/main
...
[deno-readme]: https://github.com/stdlib-js/stats-base-nanmskmax/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-nanmskmax/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-nanmskmax/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-nanmskmax/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-nanmskmax/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-nanmskmax/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-nanmskmax/main/LICENSE

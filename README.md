...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-nanmskmax/tags). For example,

```javascript
nanmskmax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanmskmax@v0.2.0-umd/browser.js' )
```

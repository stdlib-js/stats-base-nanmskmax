...
```javascript
import nanmskmax from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanmskmax@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-nanmskmax/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-base-nanmskmax/actions/workflows/test.yml?query=branch:v0.1.0

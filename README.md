...
```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanmskmax@deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-nanmskmax/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-base-nanmskmax/actions/workflows/test.yml?query=branch:main

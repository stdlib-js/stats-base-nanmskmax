...
```javascript
nanmskmax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanmskmax@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanmskmax@umd/bundle.js"></script>
```
